...
- bounded global data-plane admission (`max_inflight_requests`, default 256); the admission queue (default: wait while the client is connected) so a burst of Claude Code sub-agents is served instead of 503'd; health, readiness, metrics and Admin diagnostics remain responsive
