...
- bounded global data-plane admission (`max_inflight_requests`, default 256) with a 30s queue so a burst of Claude Code sub-agents waits for a slot instead of an immediate 503; health, readiness, metrics and Admin diagnostics remain responsive
